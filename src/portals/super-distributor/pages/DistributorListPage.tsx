...
export default function DistributorListPage2() {
  ...
  return (
    <ClientTable
      ...
      onEdit={(row) => navigate(`/super-distributor/distributors/edit/${row.id}`)}
      onCreate={() => navigate('/super-distributor/distributors/create')}
