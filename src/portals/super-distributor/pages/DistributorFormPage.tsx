...
} from '../hooks/distributors.hooks';
// import { useSuperDistributors } from '../../wl-admin/hooks/superDistributors.hooks';
import { notifications } from '@mantine/notifications';
import { useAuthStore } from '../../../stores/useAuthStore';

export default function DistributorFormPage2() {
  ...
  const { data: all = [], isLoading } = useDistributors();
  // const { data: superDistributors = [] } = useSuperDistributors();
    ...
    <Container fluid size="lg">
      ...
      <Stack>
        ...
        {/* <Select
          ...
          data={superDistributors.map((sd) => ({ value: sd.id, label: sd.name }))}
