// src/pages/wl-admin/SuperDistributorListPage.tsx
import {
  Badge,
  Button,
  Container,
  ...
  return (
    <Container size="lg">
      <Group justify="space-between" mb="md">
        <Title order={2}>Super Distributors</Title>
        <Button leftSection={<IconPlus size={16} />} onClick={() => navigate('/wl-admin/super-distributors/create')}>
          Add
        </Button>
      </Group>
              ...
              <Table.Td>
                <Group gap="xs">
                  <Button
                    size="xs"
                    variant="light"
                    onClick={() => navigate(`/wl-admin/super-distributors/${u.id}/edit`)}
